...
/**
 * 
 * SeekableByteChannel implementation for Binary access.
 *
 */
public class BinaryByteChannel implements SeekableByteChannel {
    ...
    public BinaryByteChannel(Binary binary) throws RepositoryException {
        this.binary = binary;
        init();
    }
        ...
        if(newPosition > position) {
            ...
            if(!tryReset()) {
                try {
                    ...
                    throw new IOException("Unable to set position to " + newPosition, e);
                }
            }
    ...
    public long size() throws IOException {
        try {
            ...
            throw new IOException("Unable to get size.", e);
        }
    }
